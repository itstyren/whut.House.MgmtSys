                ...
                <el-row>
                  <el-col :span="8"
                    ...
                    <el-form-item label="职工姓名">
                      <el-input v-model="hireSuperForm.staffName"
                                readonly
                ...
                <el-row>
                  <el-col :span="17"
                    ...
                    <el-form-item label="住房分配">
                      <el-input v-model="hireSuperForm.houseName"
                                size="small"
                                readonly
                                placeholder="请选择住房">
                ...
                <el-row>
                  <el-col :span="10"
                    ...
                    <el-form-item label="登记说明"
                                  prop="directApplyNote">
                      <el-input v-model="hireSuperForm.directApplyNote"
                                type="textarea"
                                :rows="2"
                  ...
                  <el-col :span="5"
                          :offset="2">
                    <el-button type="primary"
                               @click="hireSuperSubmit">提交</el-button>
                  </el-col>
                </el-row>
              </el-form>
            </div>
