  ...
  <div class="page">
    <div class="_card fix-detail ">
      ...
      <div class="content">
        ...
        />
        <zan-field v-if="paramBase.formData.oldStaff" v-bind="Object.assign({}, handleFunctions, paramBase.usedArea)" :disabled="true" v-model.lazy="paramBase.formData.usedArea"
        />
        <zan-field v-if="paramBase.formData.oldStaff" v-bind="Object.assign({}, handleFunctions, paramBase.areaNotUpToStandard)" :disabled="true" v-model.lazy="paramBase.formData.areaNotUpToStandard"
   />
    ...
    <div class="_card formula ">
        <strong>核算标准：</strong>
        <span>逐月住房补贴(元)=职工月工资总额×1.2806×20％÷职工住房补贴面积标准×未达标面积</span><br />
...
import { getStaffMonetaryParameter } from "@/api";
export default {
  data() {
    return {
      staffID: "",
