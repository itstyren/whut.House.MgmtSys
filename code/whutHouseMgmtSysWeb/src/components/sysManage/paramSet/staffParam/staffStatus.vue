...
<el-col :span="24" class="right-main">
  <el-col :span="24" class="topic"><h1>职工状态参数</h1></el-col>
  <!-- 工具条 -->
  ...
  <!-- 表格区域 -->
  <el-col :span="24">
    <el-table :data="statusDate" border style="width:100%" v-loading="listLoading" max-height="450">
  ...
  <el-col :span="24" >
    ...
    <!-- 新增表单 -->
    <el-dialog title="新增状态名称" :visible.sync="addFormVisible" v-loading="submitLoading" >
    ...
    <!-- 编辑表单 -->
    <el-dialog title="编辑状态名称" :visible.sync="modifyFormVisible" v-loading="modifyLoading">
