...
// 维修管理--维修受理
// 受理信息获取
export function getFixAccept(params, type, roleId) {
  return request({
    url: `/fix/getAccept/${type}/${roleId}`,
    method: 'get',
    params: params
  })
}
...
// 维修管理--维修审核
// 需要审核信息获取
export function getFixAgree(params, type, roleId) {
  return request({
    url: `/fix/getAgree/${type}/${roleId}`,
    method: 'get',
    params: params
  })
}
...
// 维修管理-维修申请管理
// 获取维修申请
export function getFixForm(params, roleId) {
  return request({
    url: `/fix/getFixManagement/${roleId}`,
    method: 'get',
    params: params
  })
}
...
// 维修管理-维修结算
// 多条件查找
export function postFixmulticondition(param, data, roleId) {
  return request({
    url: `/fix/getCheckByAllMultiCondition/${roleId}?page=${param.page}&size=${param.size}`,
    method: 'post',
    data: data
  })
}
