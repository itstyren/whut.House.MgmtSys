  ...
  <div class="third-container">
    ...
    <div class="warp-breadcrum">
      <el-breadcrumb separator="/">
        ...
        <el-breadcrumb-item>享受面积</el-breadcrumb-item>
      </el-breadcrumb>
    </div>
    <!-- 下方主内容 -->
    <div class="warp-body">
        ...
        <el-popover ref="addPopver"
          ...
          <div style="text-align: right; margin:0">
            <el-button type="primary"
                       size="mini"
                       @click="popoverVisible=false">确定</el-button>
          </div>
        </el-popover>
        <el-form :inline="true"
                 style="margin-bottom:15px">
          <el-button type="primary"
                     v-popover:addPopver>新增职称</el-button>
        </el-form>
      </div>
      <!-- 表格区 -->
      <div class="main-data">
        <el-table :data="PostValData"
                  class="table"
          ...
          <el-table-column prop="staffParamName"
                           label="职称类别"
                           sortable
                           align="center"></el-table-column>
          <el-table-column prop="staffParamHouseArea"
                           label="享受面积"
                           sortable
                           align="center"></el-table-column>
    ...
    <el-dialog title="编辑职称分"
      ...
      <el-form :model="modifyFromBody"
        ...
        <el-row>
          <el-col :span="20">
            <el-form-item label="职称类别"
                          prop="staffParamName">
              <el-input v-model="modifyFromBody.staffParamName"
        ...
        <el-row>
          <el-col :span="20">
            <el-form-item label="享受面积"
                          prop="staffParamHouseArea">
              <el-input v-model="modifyFromBody.staffParamHouseArea"
                        placeholder="请输入享受面积"></el-input>
            </el-form-item>
          </el-col>
        </el-row>
      </el-form>
