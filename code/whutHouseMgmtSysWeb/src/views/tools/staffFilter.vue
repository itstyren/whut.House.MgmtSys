      ...
      <el-row>
        <el-col :span="4">
          <el-form-item label="职工部门">
            <el-select v-model="queryForm.deptId" size="small" :clearable="true" placeholder="全部部门">
        ...
        <el-col :span="3">
          <el-form-item label="职工职务">
            <el-select v-model="queryForm.postId" size="small" :clearable="true" placeholder="全部职务">
        ...
        <el-col :span="5">
          <el-form-item label="职工职称">
            <el-select v-model="queryForm.titleId" size="small" :clearable="true" placeholder="全部职称">
        ...
        <el-col :span="3">
          <el-form-item label="职工类别">
            <el-select v-model="queryForm.typeId" size="small" :clearable="true" placeholder="全部类别">
              <el-option v-for="v in staffType" :key="v.staffParamId" style="text-align:center" :value="v.staffParamId" :label="v.staffParamName"></el-option>
            </el-select>
          </el-form-item>
        </el-col>
        <el-col :span="5">
          <el-form-item label="起止时间">
            <el-row>
              <el-col :span="10">
                <el-date-picker v-model="tempData.yearStart" type="year" size="small" align="center" placeholder="起始" value-format="yyyy-MM-dd"></el-date-picker>
              </el-col>
              <el-col style=" text-align: center;" :span="4">
                <span>至</span>
              </el-col>
              <el-col :span="10">
                <el-date-picker v-model="tempData.yearEnd" type="year" size="small" align="center" placeholder="终止" value-format="yyyy-MM-dd"></el-date-picker>
              </el-col>
            </el-row>
          </el-form-item>
        </el-col>
