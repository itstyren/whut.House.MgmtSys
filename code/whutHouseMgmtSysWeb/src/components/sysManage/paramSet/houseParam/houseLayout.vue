...
<el-col :span="24" class="right-main">
  ...
  <el-col :span="24">
    <el-table :data="typeData" border style="width:100%" v-loading="listLoading">
      ...
      <el-table-column prop="houseLayout" label="住房户型" sortable align="center" ></el-table-column>
  ...
  <el-col :span="24" >
    ...
    <el-dialog title="新增住房户型" :visible.sync="addFormVisible" v-loading="submitLoading" >
      <el-form :model="addFormBody" label-width="80px" ref="addForm" :rules="rules" auto>
        <el-form-item label="住房户型" prop="houseLayout">
          <el-input v-model="addFormBody.houseLayout" placeholder="请输入住房户型"  ></el-input>
        </el-form-item>     
      </el-form>
    ...
    <el-dialog title="编辑住房类型" :visible.sync="modifyFormVisible" v-loading="modifyLoading">
      <el-form :model="modifyFromBody" label-width="80px" ref="modifyFrom" :rules="rules" >
        <el-form-item label="住房类型" prop="houseLayout"  >
          <el-input v-model="modifyFromBody.houseLayout" placeholder="请输入住房类型"  ></el-input>
        </el-form-item>   
      </el-form>
      <div slot="footer" class="dialog-footer">
