  ...
  <div class="third-container">
    ...
    <div class="warp-breadcrum">
      <el-breadcrumb separator="/">
        ...
        <el-breadcrumb-item>职称</el-breadcrumb-item>
      </el-breadcrumb>
    </div>
    <!-- 下方主内容 -->
    <div class="warp-body">
      ...
      <!-- 表格区 -->
      <div class="main-data">
        <el-table :data="tittleData" class="table" v-loading="listLoading" height="string">
    ...
    <!-- 新增表单 -->
    <el-dialog title="新增职称名称" class="paramDialog" :visible.sync="addFormVisible" v-loading="submitLoading">
    ...
    <!-- 编辑表单 -->
    <el-dialog title="编辑职称名称" class="paramDialog" :visible.sync="modifyFormVisible" v-loading="modifyLoading">
