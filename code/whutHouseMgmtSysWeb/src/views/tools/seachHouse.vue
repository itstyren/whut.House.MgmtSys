            ...
            <el-col :span="5">
              <el-form-item label="住房类型">
                <el-select v-model="queryForm.houseTypeId"
                           ...
                           :clearable="true"
                           placeholder="全部类型">
                  <el-option v-for="struct in hosueParam.typeData"
                             :key="struct.houseParamId"
                             :value="struct.houseParamId"
                             :label="struct.houseParamName"></el-option>
                </el-select>
              </el-form-item>
            </el-col>
            <el-col :span="5">
              <el-form-item label="住房状态">
                <el-select v-model="queryForm.useStatusId"
                           ...
                           :clearable="true"
                           placeholder="全部状态">
                  <el-option v-for="struct in hosueParam.statusData"
                             :key="struct.houseParamId"
                             :value="struct.houseParamId"
                             :label="struct.houseParamName"></el-option>
                </el-select>
            ...
            <el-col :span="5">
              <el-form-item label="住房结构">
                <el-select v-model="queryForm.structId"
                           ...
                           :clearable="true"
                           placeholder="全部结构">
                  <el-option v-for="struct in hosueParam.structData"
                             :key="struct.houseParamId"
                             :value="struct.houseParamId"
                             :label="struct.houseParamName"></el-option>
                </el-select>
            ...
            <el-col :span="5">
              <el-form-item label="住房户型">
                <el-select v-model="queryForm.layoutId"
                           ...
                           :clearable="true"
                           placeholder="全部户型">
                  <el-option v-for="struct in hosueParam.layoutData"
                             :key="struct.houseParamId"
                             :value="struct.houseParamId"
                             :label="struct.houseParamName"></el-option>
                </el-select>
          ...
          <el-row type="flex"
            ...
            <el-col :span="5">
              <el-form-item label="住房面积">
                <el-row>
                  <el-col :span="10">
                    <el-input v-model="tempData.minArea"
                              size="small"
                  ...
                  <el-col :span="10">
                    <el-input v-model="tempData.maxArea"
                              size="small"
                              placeholder="不限"></el-input>
                  </el-col>
                </el-row>
            ...
            <el-col :span="10">
              <el-form-item label="建设时间">
                <el-row>
                  ...
                  <el-col :span="10">
                    <el-date-picker v-model="tempData.endTime"
                                    type="year"
                                    size="small"
                                    align="center"
                                    placeholder="终止"
            ...
            <el-col :span="5">
              <el-form-item label="住房校区">
                <el-select v-model="queryForm.campusId"
                           size="small"
                           :clearable="true"
                           @clear="clearCampus"
                           placeholder="全部校区">
                  <el-option v-for="campuse in hosueParam.campusData"
                             :key="campuse.id"
                             :value="campuse.id"
                             :label="campuse.name"></el-option>
                </el-select>
              </el-form-item>
            </el-col>
          </el-row>
          <el-row type="flex"
            ...
            <el-col :span="7">
              <el-form-item label="住房区域">
                <el-select v-model="queryForm.regionId"
                  ...
                  <el-option v-for="region in hosueParam.regionData"
                             :key="region.id"
                             :value="region.id"
            ...
            <el-col :span="7">
              <el-form-item label="房屋楼栋">
                <el-select v-model="queryForm.buildingId"
                           size="small"
                           :clearable="true"
                           placeholder="全部房屋">
                  <el-option v-for="building in hosueParam.buildingData"
                             :key="building.id"
                             :value="building.id"
      ...
      <div class="query-table card">
        <el-table :data="houseData"
          ...
          <el-table-column label="住房类型"
                           align="center"
                           width="120"
                           prop="houseSort"></el-table-column>
          <el-table-column label="户型"
                           align="center"
                           width="100"
                           prop="houseType"></el-table-column>
          ...
          <el-table-column label="使用状态"
                           align="center"
                           width="100"
                           prop="useStatus"></el-table-column>
