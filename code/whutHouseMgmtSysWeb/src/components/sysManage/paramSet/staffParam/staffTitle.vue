...
<el-col :span="24" class="right-main">
  ...
  <el-col :span="24">
    <el-table :data="typeData" border style="width:100%" v-loading="listLoading">
      ...
      <el-table-column prop="staffTitle" label="职称名" sortable align="center" ></el-table-column>
  ...
  <el-col :span="24" >
    ...
    <el-dialog title="新增职称名称" :visible.sync="addFormVisible" v-loading="submitLoading" >
      <el-form :model="addFormBody" label-width="80px" ref="addForm" :rules="rules" auto>
        <el-form-item label="职称名称" prop="staffTitle">
          <el-input v-model="addFormBody.staffTitle" placeholder="请输入职称名称"  ></el-input>
        </el-form-item>     
      </el-form>
    ...
    <el-dialog title="编辑职称名称" :visible.sync="modifyFormVisible" v-loading="modifyLoading">
      <el-form :model="modifyFromBody" label-width="80px" ref="modifyFrom" :rules="rules" >
        <el-form-item label="职称名称" prop="staffTitle"  >
          <el-input v-model="modifyFromBody.staffTitle" placeholder="请输入职称名称"  ></el-input>
        </el-form-item>   
      </el-form>
      <div slot="footer" class="dialog-footer">
