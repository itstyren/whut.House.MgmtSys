...
<el-col :span="24" class="right-main">
  <el-col :span="24" class="topic" ><h1>租金选项设置</h1></el-col>
  <!-- 工具条 -->
   ...
   watch:{
       rentalOption:{
           handler:function(newVal){
               this.rentalData.push({ param:'新老职工时间分界点',
                                      paramVal:newVal.rentalTimeDiv})
               this.rentalData.push({ param:'老职工优惠比例',
                                      paramVal:newVal.rentalOldDct})
               this.rentalData.push({ param:'新职工优惠年限',
                                      paramVal:newVal.rentalNewDctYear})
               this.rentalData.push({ param:'新职工优惠比例',
