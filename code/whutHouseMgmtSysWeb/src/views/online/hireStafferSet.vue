          ...
          <div class="main-data">
            <el-tabs v-model="activeName"
              ...
              <el-tab-pane name="canSelect">
                <span slot="label">
                  <my-icon icon-class="users"></my-icon>待选员工
                </span>
                <keep-alive>
                  <!-- 未设置选房的表格 -->
                  <div v-if="activeName=='canSelect'"
                       class="table-tabs">
                    <el-table :data="canSelectData"
                              class="table"
                              height="string"
                    ...
                    <div class="bottom-tool">
                      <el-button type="primary"
                                 size="small"
                                 @click="setSelect">设为可选</el-button>
                    </div>
                  </div>
                </keep-alive>
              </el-tab-pane>
              <el-tab-pane name="haveSleect">
                <span slot="label">
                  <my-icon icon-class="users"></my-icon>可选员工
                </span>
                <keep-alive>
                  <!-- 已设置选房的表格 -->
                  <div v-if="activeName=='haveSleect'"
                       class="table-tabs">
                    <el-table :data="haveSelectData"
                              class="table"
                              height="string"
                    ...
                    <div class="bottom-tool">
                      <el-button type="warning"
                                 size="small"
                                 @click="cancelSelect">撤销可选</el-button>
                    </div>
                  </div>
                </keep-alive>
              </el-tab-pane>
