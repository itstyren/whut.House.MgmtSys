package com.computerdesign.whutHouseMgmt.dao.param.houseparam;
...
public interface HouseParameterMapper {
	...
	int updateByExampleSelective(@Param("record") HouseParameter record,
			@Param("example") HouseParameterExample example);
