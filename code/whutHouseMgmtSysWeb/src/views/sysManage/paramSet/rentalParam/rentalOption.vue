        ...
        <el-row>
          <el-col :span="20">
            <el-form-item label="新老职工分界点：" prop="rentalTimeDiv">
              <el-slider v-model="modifyFromBody.rentalTimeDiv" show-input :max="9999"></el-slider>
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          <el-col :span="20">
            <el-form-item label="老职工优惠比例:" prop="rentalOldDct">
              <el-slider v-model="modifyFromBody.rentalOldDct" show-input :step="0.01" :max="1"></el-slider>
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          <el-col :span="20">
            <el-form-item label="新职工优惠年限:" prop="rentalNewDctYear">
              <el-slider v-model="modifyFromBody.rentalNewDctYear" show-input :max="9999"></el-slider>
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          <el-col :span="20">
            <el-form-item label="新职工优惠比例:" prop="rentalNewDct">
              <el-slider v-model="modifyFromBody.rentalNewDct" show-input :step="0.01" :max="1"></el-slider>
            </el-form-item>
          </el-col>
        </el-row>
      </el-form>
