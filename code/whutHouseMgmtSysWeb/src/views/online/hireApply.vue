            ...
            <div class="apply-from card" v-loading="listLoading">
              ...
              <el-form :model="accoutInfo" label-width="100px" inline ref="hireApplyForm" :rules="rules">
                  ...
                  <el-row type="flex" justify="center" class="apply-list">
                    <el-col :span="20">
                      <el-table :data="accoutInfo.array" border class="table" height="string" v-loading="listLoading">
                        <el-table-column label="职工号" prop="staffNo"></el-table-column>
                        <el-table-column label="申请号" prop="id"></el-table-column>
                        <el-table-column label="职工积分" prop="staffVal"></el-table-column>
                        <el-table-column label="处理情况" prop="hireState"></el-table-column>
                      </el-table>
                    </el-col>
                  </el-row>
                ...
                <div v-if="active==2" class="hire-reason">
                  <el-row type="flex" justify="center">
                    <el-col :span="20">
                      <el-form-item label="申请原因" prop="reason">
                        <el-input v-model="accoutInfo.reason" type="textarea" style="width:600px" :rows="6" placeholder="请详细说明您的住房困难及需求,并留下您的联系方式，以便工作人员与您联系">
                        </el-input>
                      </el-form-item>
                    </el-col>
                  </el-row>
                  <!-- <el-row type="flex" justify="center" class="remark">
                    <el-col :span="20">
                      <span>注意：请详细说明您的住房困难及需求,并留下您的联系方式，以便工作人员与您联系</span>
                    </el-col>
                  </el-row> -->
                </div>
