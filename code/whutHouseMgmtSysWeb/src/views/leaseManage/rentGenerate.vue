  ...
  <div class="second-container">
    ...
    <section class="main-container">
      <div class="third-container">
        ...
        <div class="warp-body">
          ...
          <div class="toolbar card">
            <el-row type="flex" align="middle">
              ...
              <el-col :span="3">
                <el-input v-model="directQuery" placeholder="输入姓名或id检索"></el-input>
              </el-col>
              <el-col :span="2" :offset="1">
                <el-button type="primary" @click="directQueryMthod">查找</el-button>
              </el-col>
              <el-col :span="2">
                <!-- <transition name="fade"> -->
                <el-button type="primary" v-if="activeName=='staff'" @click="showDialog">条件检索</el-button>
                <!-- </transition> -->
              </el-col>
              ...
              <el-col :span="2" :offset="1">
                <export-popover v-if="activeName=='rental'" :download-loading="downloadLoading" @export="exportHandle"></export-popover>
              </el-col>
            </el-row>
          </div>
          <div class="main-data">
                ...
                <keep-alive>
                  <div v-if="activeName=='staff'" class="table-tabs">
                    <el-table :data="hireStaffData" class="table" style="width: 100%" height="string" v-loading="listLoading" @selection-change="setSelectionChange">
                      ...
                      <el-table-column prop="staffNo" fixed label="职工号" width="70" align="center"></el-table-column>
                      ...
                      <el-table-column prop="bookTime" label="入住时间" fixed width="100" align="center"></el-table-column>
                      ...
                      <el-table-column prop="houseNo" label="住房号" fixed="right" width="70" align="center"></el-table-column>>
                      <el-table-column label="地址" fixed="right" width="260" align="center">
                        <template slot-scope="scope">
                          <el-popover trigger="hover" placement="top">
        ...
        <!-- 多条件查询窗口 -->
        <el-dialog title="条件检索" class="multiply-diolog" v-loading="dialogLoading" :visible.sync="dialogVisible">
          <el-form :model="queryForm" label-width="90px">
            <el-row>
              <el-col :span="8">
                <el-form-item label="工作部门">
                  <el-select v-model="queryForm.dept" :clearable="true" placeholder="所有部门">
              ...
              <el-col :span="8">
                <el-form-item label="职务">
                  <el-select v-model="queryForm.post" :clearable="true" placeholder="所有职务">
              ...
              <el-col :span="8">
                <el-form-item label="职称">
                  <el-select v-model="queryForm.title" :clearable="true" placeholder="所有职称">
            ...
            <el-row>
              ...
              <el-col :span="8">
                <el-form-item label="工作状态">
                  <el-select v-model="queryForm.status" :clearable="true" placeholder="所有状态">
              ...
              <el-col :span="8">
                <el-form-item label="住房类型">
                  <el-select v-model="queryForm.houseTypeName" :clearable="true" placeholder="所有类型">
            ...
            <el-row>
              <el-col :span="8">
                <el-form-item label="婚姻状况">
                  <el-select v-model="queryForm.marriageState" :clearable="true" placeholder="全部">
              ...
              <el-col :span="8">
                <el-form-item label="性别">
                  <el-select v-model="queryForm.sex" :clearable="true" placeholder="全部">
              ...
              <el-col :span="8">
                <el-form-item label="是否到期">
                  <el-select v-model="queryForm.isExpire" :clearable="true" placeholder="全部">
                    <el-option v-for="v in formOption.hireIsExpire" :key="v.value" :value="v.value" :label="v.label"></el-option>
                  </el-select>
                </el-form-item>
              </el-col>
            </el-row>
