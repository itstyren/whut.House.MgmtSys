<template>
  <div class="second-container">
          ...
          <div class="main-data">
            <el-row class="user-info"
                ...
                <el-col :span="19"
                  ...
                  <div class="info-form card">
                    ...
                    <el-row class="info-row"
                      ...
                      <!-- 手机号编辑,提交,取消按钮 -->
                      <el-col :span="3">
                        <div v-if="ismodifyTel"
                             class="btn-submit-cancel">
                          <el-button size="mini"
                                     type="primary"
                                     @click="handleSubmitTel(tel)">提交</el-button>
                          <el-button type="infor"
                                     size="mini"
                                     @click="ismodifyTel=!ismodifyTel">取消</el-button>
                        </div>
                        <el-button type="infor"
                                   v-else
                                   @click="handleModifyTel"
                    ...
                    <el-row class="info-row"
                      ...
                      <el-col :span="14">
                        ...
                        <strong v-else
                                style="color:#666">{{staffInfo.email?staffInfo.email:'暂无'}}</strong>
                      </el-col>
                      <!-- 邮箱编辑,提交,取消按钮 -->
                      ...
                      <el-col :span="3">
                        <div v-if="ismodifyEmail"
                          ...
                          <el-button size="mini"
                                     type="primary"
                                     @click="handleSubmitEmail(email)">提交</el-button>
                          <el-button type="infor"
                                     size="mini"
                                     @click="ismodifyEmail=!ismodifyEmail">取消</el-button>
                        </div>
                        <el-button type="infor"
                                   v-else
              ...
              <keep-alive>
                <el-col :span="19"
                        v-loading="listLoading"
                        v-if="menuIndex=='house'">
                  <el-row v-if="houseList.length===0">
                    <el-col :span="24"
                  ...
                  <el-row v-for="(item,index) in houseList"
                          :key="item.address">
                    <el-col :span="24"
                            class="info-form card">
                      <div class="title">
              ...
              <keep-alive>
                <el-col :span="19"
                        v-loading="listLoading"
                        v-if="menuIndex=='monetarySub'">
                  <div class="info-form card">
                    <div class="title">
                      <h1>补贴信息</h1>
                    </div>
                    <div class="fix-result">
                      <el-table ref=monetaryTable
                                :data="monetaryList"
                                class="table"
                                height="string"
                                v-loading="listLoading">
                        ...
                        <el-table-column label="年度工资"
                                         prop="annualSal"
                                         align="center"></el-table-column>
                        <el-table-column label="年度补贴金"
                                         prop="subsidies"
                                         align="center"></el-table-column>
                        ...
                        <el-table-column label="操作"
                          ...
                          <template slot-scope="scope">
                            ...
                            <el-button type="success"
                                       @click="fixComment(scope.row)"
                                       v-if="scope.row.isCheck==true&&scope.row.ratings==null"
                            ...
                            <el-row style="margin-bottom:20px;"
                              ...
                              <el-col :span="4">
                                <el-button type="primary"
                                           size="mini"
                                           @click="downloadApply">导出申请表</el-button>
                              </el-col>
                            </el-row>
                          </template>
                        </el-table-column>
                        <el-table-column label="预分配地址"
                                         width="280"
                                         prop="address"
                                         align="center"></el-table-column>
                        <el-table-column label="申请时间"
                        ...
                        <el-row>
                          <el-col :span="10"
                            ...
                            <el-form-item label="确认新密码"
                              ...
                              <el-input v-model="passwordForm.checkNewPassword"
                                        placeholder="请输入旧密码"
                                        type="password"></el-input>
                            </el-form-item>
                          </el-col>
    ...
    <el-dialog title="维修评价"
               class="fix-comment"
               :visible.sync="fixCommentVisible"
               v-loading="commentLoading">
      <el-form :model="fixCommentForm"
               label-width="100px">
        <el-row>
          <el-col :span="18"
                  :offset="1">
            <el-form-item label="维修类型">
              <el-input v-model="fixCommentForm.fixType"
                        readonly></el-input>
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          <el-col :span="18"
            ...
            <el-form-item label="申请时间">
              <el-input v-model="fixCommentForm.applyTime"
                        readonly></el-input>
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          <el-col :span="18"
            ...
            <el-form-item label="处理状态">
              <el-input v-model="fixCommentForm.fixState"
                        readonly></el-input>
            </el-form-item>
          </el-col>
        </el-row>
          ...
          <el-col :span="18"
            ...
            <el-form-item label="评价">
              ...
              <el-row style="margin-top:20px;">
                <el-col :span="21"
                        :offset="2">
                  <el-rate v-model="fixCommentForm.comment"
                           show-text></el-rate>
                </el-col>
              </el-row>
            </el-form-item>
      ...
      <div slot="footer"
        ...
        <el-button type="primary"
                   @click.native="submitComment">提交</el-button>
      </div>
    </el-dialog>
  </div>
</template>
...
export default {
  ...
  methods: {
    ...
    handleModifyTel () {
      this.tel = this.staffInfo.tel
      this.ismodifyTel = true

    },
    handleModifyEmail () {
      this.email = this.staffInfo.email
