...
public class HireGetDirectApply {
    ...
    private List<HouseGetDirectApply> listHouseGetDirectApply ;
    ...
    public HireGetDirectApply(ViewStaff viewStaff) {
    	...
    	this.goUniversityTime = viewStaff.getGoUniversityTime();
	...
	public List<HouseGetDirectApply> getListHouseGetDirectApply() {
		return listHouseGetDirectApply;
	}

	public void setListHouseGetDirectApply(List<HouseGetDirectApply> listHouseGetDirectApply) {
