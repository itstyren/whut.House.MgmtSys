  ...
  <div class="third-container">
    ...
    <div class="warp-breadcrum">
      <el-breadcrumb separator="/">
        ...
        <el-breadcrumb-item>工作状态</el-breadcrumb-item>
      </el-breadcrumb>
    </div>
    <!-- 下方主内容 -->
    <div class="warp-body">
      ...
      <!-- 表格区 -->
      <div class="main-data">
        <el-table :data="statusDate" class="table" v-loading="listLoading" height="string">
          <el-table-column type="selection" width="55"></el-table-column>
          <el-table-column type="index" width="65" label="序号" style="text-aligin:center" align="center"></el-table-column>
          <el-table-column prop="staffParamName" label="状态名" sortable align="center"></el-table-column>
    ...
    <!-- 新增表单 -->
    <el-dialog title="新增状态名称" class="paramDialog" :visible.sync="addFormVisible" v-loading="submitLoading">
      <el-form :model="addFormBody" label-width="100px" ref="addForm" :rules="rules" auto>
        <el-row>
          <el-col :span="20">
            <el-form-item label="状态名称" prop="staffParamName">
              <el-input v-model="addFormBody.staffParamName" placeholder="请输入状态名称"></el-input>
            </el-form-item>
          </el-col>
        </el-row>
      </el-form>
    ...
    <!-- 编辑表单 -->
    <el-dialog title="编辑状态名称" class="paramDialog" :visible.sync="modifyFormVisible" v-loading="modifyLoading">
      <el-form :model="modifyFromBody" label-width="100px" ref="modifyFrom" :rules="rules">
        <el-row>
          <el-col :span="20">
            <el-form-item label="状态名称" prop="staffParamName">
              <el-input v-model="modifyFromBody.staffParamName" placeholder="请输入状态名称"></el-input>
            </el-form-item>
          </el-col>
        </el-row>
      </el-form>
    ...
    methods: {
      ...
      getList() {
        ...
        getStaffParam(param, this.paramClass).then((res) => {
          this.statusDate = res.data.data.data.list
