...
<el-col :span="24" class="right-main">
  ...
  <!-- 表格区域 -->
  <el-col :span="24">
    <el-table :data="statusData" border style="width:100%" v-loading="listLoading" max-height="450">
      ...
      <el-table-column prop="houseParamName" label="使用状态" sortable align="center" ></el-table-column>
        <el-table-column label="操作" width="200" align="center">
          <template slot-scope="scope" >
            ...
            <el-button type="danger" size="small" @click="delectStatus(scope.$index,scope.row)" >删除</el-button>
          </template>
        </el-table-column>      
    </el-table>
  </el-col>
